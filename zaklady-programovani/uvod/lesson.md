...
1. Stáhněte si instalaci jazyka Python z [tohoto odkazu](https://www.python.org/ftp/python/3.7.1/python-3.7.1-amd64.exe). Stažený soubor spusťte. Rozeběhne se průvodce instalací.
1. Na úvodní obrazovce je **velmi důležité** zaškrtnout volbu **Add Python 3.7 to PATH** (viz obrázek)
   ![Instalace Pythonu](/czechitas/python-data/assets/zaklady-programovani/uvod/python-setup.png){.fig .fig-100}
...
![VS Code Terminal](/czechitas/python-data/assets/zaklady-programovani/uvod/vscode-term.png){.fig}
